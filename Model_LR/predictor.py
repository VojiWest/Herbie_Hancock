...
def predict_bach(last_timestep, model, output_to_input_converter, timesteps = 400):
    preds = []
    with torch.no_grad():
        for step in range(timesteps):
            ...
            aug_output = augmented_encoding(raw_input_domain_output)
            ...
            preds.append(raw_input_domain_output[0])
