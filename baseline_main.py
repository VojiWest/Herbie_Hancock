...
def main():
    ...
    ds_voice = baseline_dataset.CustomDataset(window_size=window_size, voice_num=voice_num, val_ratio=0) # set val_ratio to 0 to use all data for training
    ...
    plot.plot_certainty(all_preds, title = "Baseline Certainty of Predictions", xlabel = "Time", ylabel = "Note") # Plot certainty of each note over timesteps
    plot.plot_data(all_data, title = "Baseline Original Data", xlabel = "Time", ylabel = "Note") # plot original notes
    plot.plot_data(new_data, title = "Baseline Original + Predicted Data", xlabel = "Time", ylabel = "Note") # plot the original + predicted notes
